...
class MailDemo1 extends StatelessWidget {
  MailDemo1({super.key});
  List<Map<String, dynamic>> maildata1 = [
    {
      'icon': Icons.group_outlined,
      'color1': Colors.blue.shade500,
      'text1': "Social",
      'text2': "Udemy,Instagram,LinkedIn,Facebook,Messenger,Snapchat,Facebook",
  ...
  List<Map<String, dynamic>> maildata2 = [
    {
    ...
    },
    {
      ...
      'text5':
          "If an FIR is registered against you, the police will in all probability investigate the case. If its a fake FIR and no case is found against you by the police, the",
    },
    {
              ...
              children: List.generate(
                  ...
                  (index) => Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              maildata1[index]['icon'],
                              color: maildata1[index]['color1'],
                            ),
                            const SizedBox(
                              width: 20,
                            ),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: maildata1[index]['color2'],
                                borderRadius:
                                    const BorderRadius.all(Radius.circular(10)),
                              ),
                              child: Text(
                                maildata1[index]['text3'],
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 10,
                                ),
                  ...
                  (index) => Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            CircleAvatar(
                              radius: 20,
                              backgroundColor: maildata2[index]['color'],
                              child: Text(
                                maildata2[index]['text1'],
                                style: const TextStyle(
                                  color: Colors.black,
                                  fontSize: 25,
                                ),
